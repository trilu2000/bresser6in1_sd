...
- Only required if using CUL v3 or SIGNALduino  
- Recommended firmware for CUL v3: `SIGNALduino_culV3CC1101_onlyFsk_335dev20220521.hex`  
- Use [Busware CUL Flasher](https://prov.busware.de/culflasher/) to flash firmware  
...
## HACS Repository Guidelines

To make this repository HACS compatible:

1. Add a `hacs.json` file in the root of your repository with:
...
└── bresser6in1_sd/
    ...
    └── const.py
```
3. Add a `manifest.json` with version, dependencies, and Home Assistant requirement.
